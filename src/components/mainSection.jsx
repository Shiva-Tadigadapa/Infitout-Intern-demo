...
const MainSection = ({ isActive2 }) => {
  return (
    <>
      <div className="   relative   left-28 overflow-hidden top-20   ">
        <table className="  ">
          <tr className="  text-sm flex   justify-evenly bg-[#e8effb] ">
            ...
            <div className="  absolute -top-[1%] left-[46.5%] flex items-center justify-center bg-[#efe8fb]  pb-2.5 px-6 pt-2.5   border border-l-[#d5bcfe] border-b-[#d5bcfe] border-r-[#d5bcfe]">
